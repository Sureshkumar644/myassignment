...
public class DuplicateLead {
	...
	public static void main(String[] args) {
     ...
     //Duplicate lead
      ...
      //Clear company field
      WebElement comclear =driver.findElement(By.id("createLeadForm_companyName"));
      comclear.clear();
      comclear.sendKeys("Apple");
      
      //Clear and Enter new firstname
      WebElement firstclear = driver.findElement(By.id("createLeadForm_firstName"));
      firstclear.clear();
      firstclear.sendKeys("Selva");
